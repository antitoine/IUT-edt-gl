         ...
         <form class ='formulaire' method='post' action="<?php echo App_Request::getUrl('consultation'); ?>">
             <fieldset>
                 ...
                 <p>
                     ...
                     <input type='text' placeholder='Nom...' name='nom' id='nom' value='<?php echo $var["nom"]; ?>' />
                     <label for='prenom'>Prénom :</label>
                     <input type='text' placeholder='Prénom...' name='prenom' id='prenom' value='<?php echo $var["prenom"]; ?>' />
                 </p>
                 <p>ou</p>
                 <p>
                     <label for='grptd'>Groupe de TD :</label>
                     <input type='text' placeholder='Groupe de TD...' name='grptd' id='grptd' value='<?php echo $var["grptd"]; ?>' />
                 </p>
                 <p>ou</p>
                 <p>
                     <label for='bat'>Batiment :</label>
                     <input type='text' placeholder='Batiment...' name='bat' id='bat' value='<?php echo $var["bat"]; ?>' />
                     <label for='salle'>Numéro salle :</label>
                     <input type='text' placeholder='Numéro salle...' name='salle' id='salle' value='<?php echo $var["salle"]; ?>' />
                 </p>
                 <p>
